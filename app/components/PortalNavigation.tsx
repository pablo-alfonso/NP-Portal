...
type Props = { isAdmin: boolean; active: "bill" | "quotes" | "settings"; collapsed: boolean; onToggle: () => void; onBillOfLading?: () => void };
...
export function PortalNavigation({ isAdmin, active, collapsed, onToggle, onBillOfLading }: Props) {
  return <aside className={`portal-navigation ${collapsed ? "collapsed" : ""}`} aria-label="Portal navigation">
    ...
    <Link className={active === "quotes" ? "portal-item active" : "portal-item"} href="/quotes">◫<b>Quotes</b></Link>
