...
export default function QuotesPage() {
  ...
  return <main className={`portal-shell quote-shell ${collapsed ? "portal-collapsed" : ""}`}>
    ...
    <section className="portal-content">
      <header className="topbar"><span>Customer portal</span><span className="quote-account">{isAdmin ? "Pablo Alfonso · NewPort" : "Afton Chemicals"} ▾</span></header>
      {!selected ? <section className="quote-page">
        <div className="quote-heading"><div><h1>Quotes</h1><p>Request a quote, review proposals and follow your quotation requests.</p></div><button className="quote-primary" onClick={() => newDraft()}>+ Request new quote</button></div>
